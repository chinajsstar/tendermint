...
script](https://github.com/chinajsstar/tendermint/blob/develop/networks/remote/integration.sh)
...
```
cd $GOPATH/src/github.com/chinajsstar/tendermint/networks/remote/terraform
```
...
directory](https://github.com/chinajsstar/tendermint/tree/master/networks/remote/ansible)
run ansible roles to configure the sentry node architecture. You must
switch to this directory to run ansible
(`cd $GOPATH/src/github.com/chinajsstar/tendermint/networks/remote/ansible`).
...
from [this
directory](https://github.com/chinajsstar/tendermint/tree/master/docs/examples).
...
```
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/chinajsstar/tendermint/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/chinajsstar/tendermint/docs/examples
```
