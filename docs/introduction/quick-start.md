...
- `$GOPATH/bin` must be on your `$PATH` (see https://github.com/chinajsstar/tendermint/wiki/Setting-GOPATH)
...
PR](https://github.com/chinajsstar/tendermint/pull/792) for more information
