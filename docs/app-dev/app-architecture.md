...
- [Tendermint in Production](https://github.com/chinajsstar/tendermint/pull/1618)
- [Tendermint Basics](https://tendermint.readthedocs.io/en/master/using-tendermint.html)
- [ABCI spec](https://github.com/chinajsstar/tendermint/blob/develop/abci/docs/abci-spec.md)
