...
```
go get github.com/chinajsstar/tendermint
```
...
[here](https://github.com/chinajsstar/tendermint/blob/develop/abci/cmd/abci-cli/abci-cli.go)
and looks like:
...
Golang](https://github.com/chinajsstar/tendermint/tree/develop/abci/server). See the
...
[here](https://github.com/chinajsstar/tendermint/blob/master/abci/cmd/abci-cli/abci-cli.go)
and looks like:
...
example directory](https://github.com/chinajsstar/tendermint/tree/develop/abci/example).
