...
import (
	...
	"github.com/chinajsstar/tendermint/lite/client"
	certerr "github.com/chinajsstar/tendermint/lite/errors"
	rpcclient "github.com/chinajsstar/tendermint/rpc/client"
...
func GetWithProofOptions(path string, key []byte, opts rpcclient.ABCIQueryOptions,
	...
	*ctypes.ResultABCIQuery, KeyProof, error) {
	...
	/* // TODO refactor so iavl stuff is not in tendermint core
	   // https://github.com/chinajsstar/tendermint/issues/1183
	if len(resp.Value) > 0 {
