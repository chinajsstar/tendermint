...
import (
	...
	types "github.com/chinajsstar/tendermint/rpc/lib/types"
)
...
// If some writes don't set it while others do, they may timeout incorrectly (https://github.com/chinajsstar/tendermint/issues/553)
