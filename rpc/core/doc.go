...
Tendermint RPC is built using [our own RPC library](https://github.com/chinajsstar/tendermint/tree/master/rpc/lib) which contains its own set of documentation and tests.
...
The first entry in the result-array (`96`) is the method this response correlates with. `96` refers to "ResultTypeBroadcastTx", see [responses.go](https://github.com/chinajsstar/tendermint/blob/master/rpc/core/types/responses.go) for a complete overview.
