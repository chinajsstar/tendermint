...
## Importing it
`import "github.com/chinajsstar/tendermint/crypto"`

## Binary encoding

For Binary encoding, please refer to the [Tendermint encoding spec](https://github.com/chinajsstar/tendermint/blob/master/docs/spec/blockchain/encoding.md).
