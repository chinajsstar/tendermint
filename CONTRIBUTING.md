...
Please follow standard github best practices: fork the repo, branch from the tip of develop, make some commits, and submit a pull request to develop. See the [open issues](https://github.com/chinajsstar/tendermint/issues) for things we need help with!
...
`$GOPATH/src/github.com/chinajsstar/tendermint `, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

  * Create the fork on github, using the fork button.
  * Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/chinajsstar/tendermint`)
...
- create a development branch either on github.com/chinajsstar/tendermint, or your fork (using `git remote add origin`)
